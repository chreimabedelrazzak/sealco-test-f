...
const BreadcrumbFour = ({ carouselId, pages }: BreadcrumbProps) => {
  ...
  return (
    <div className="overflow-hidden">
      <div className="border-t border-gray-3">
        <div className="w-full z:max-w-[1500px] mx-auto px-8 pb-4 pt-4 axl:pb-10">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <ul className="flex items-center gap-2 ">
              <li className="text-sm hover:text-[#116DB2]">
                <Link href="/">Home /</Link>
          ...
          <div className="relative">
            ...
            {(heroItem.caption || heroItem.subCaption) && (
              <div className="absolute inset-0 pointer-events-none">
                <div className="w-full z:max-w-[1500px] mx-auto px-8 h-full flex flex-col justify-end pb-28 2xl:pb-40">
