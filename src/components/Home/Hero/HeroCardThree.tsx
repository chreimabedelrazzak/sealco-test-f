...
export default function HeroCardThree({
  ...
  return (
    <div className="flex justify-center items-center min-h-[740px] 2xl:min-h-[760px]">
      <div className="w-full 2.5xl:max-w-[1500px] min-h-[740px] 2xl:min-h-[760px]">
        ...
        "
          >
            ...
            <div className="absolute inset-0 z-20 flex items-end ">
              <div className="acontainer w-full 2.5xl:max-w-[1500px]  px-8 mx-auto pb-14">
        ...
        <div className="flex items-end md:hidden bg-[#F3F4F7] pt-8 mb-20">
          <div className="acontainer w-full 2.5xl:max-w-[1500px] px-8 mx-auto pb-8 lg:pb-6 ">
