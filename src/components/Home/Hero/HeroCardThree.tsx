  ...
  return (
    <>
      <div className="relative w-full h-auto md:my-8 overflow-hidden bg-white ">
        ...
        >
          ...
          <div className="absolute inset-0 z-20 flex items-end ">
            <div className="acontainer w-full 2xl:max-w-[1600px]  px-6 xl:px-8 mx-auto pb-8 lg:pb-6 ">
              <div className="qmax-w-[400px] px-4">
                <div className="mb-4">
                  <h1 className="text-[#000000] text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                    {title}
                  </h1>
                  <h2 className="text-[#000000] text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                    {subtitle}
                  </h2>
                </div>
      ...
      <div className="flex items-end md:hidden bg-[#F3F4F7] pt-8 mb-20">
            <div className="acontainer w-full 2xl:max-w-[1600px]  px-6 xl:px-8 mx-auto pb-8 lg:pb-6 ">
              <div className="amax-w-[400px] px-4">
                <div className="mb-4">
